...
class _ResultWidgetState extends State<ResultWidget> {
        ...
        return SingleChildScrollView(
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                _buildHeader(),
                _buildPredictionList(topPrediction),
                _buildNutritionCard(topPrediction),
  ...
  Widget _buildPredictionList(Prediction topPrediction) {
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            padding: const EdgeInsets.all(12),
            decoration: BoxDecoration(
              color: isTop ? const Color(0xFF4CAF50).withOpacity(0.1) : Colors.transparent,
              borderRadius: BorderRadius.circular(12),
              border: isTop
                  ? Border.all(
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: isTop ? const Color(0xFF4CAF50) : Colors.grey[300],
                    borderRadius: BorderRadius.circular(20),
                  ),
                  child: Text(
  ...
  Widget _buildNutritionCard(Prediction topPrediction) {
    return Container(
